  ...
  if (awaitingVerification) {
    return (
      <div style={{ 
        ...
        <h1 style={{ fontSize: "32px", marginBottom: "20px", margin: "0 0 20px 0" }}>🔑 輸入驗證碼</h1>
        <p style={{ fontSize: "18px", marginBottom: "10px", margin: "0 0 10px 0" }}>已發送到：{userEmail}</p>
        <p style={{ fontSize: "14px", marginBottom: "30px", color: "#aad4b8", margin: "0 0 30px 0" }}>
          如果收件匣沒收到，可以到垃圾信件看看
        </p>
        <input
          type="text"
        ...
        <button 
          ...
          style={{ 
            padding: "12px 40px", 
            fontSize: "18px", 
            cursor: verificationCode.length >= 8 ? "pointer" : "not-allowed", 
            backgroundColor: verificationCode.length >= 8 ? "#4CAF50" : "#ccc", 
            color: "white", 
            border: "none", 
            borderRadius: "5px", 
            fontWeight: "bold",
